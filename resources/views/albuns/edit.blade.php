<x-layout title="Editar álbum: {{ $album->nome }}">
    <form class="row g-3" action="/albuns/salvar/{{ $album->id }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-6">
            ...
            <input value="{{ $album->artista }}" type="text" class="form-control" id="artista" name="artista"
                required>
        </div>
        <div class="col-6">
        ...
        <div class="col-md-6">
            ...
            <input value="{{ $album->preco }}" type="number" min="1" step="any" class="form-control" id="preco"
                name="preco" required>
        </div>
        <div class="col-12">
